...
import { pagesOptions } from '../buttonPages';
 ...
 *
 */
export declare function embedPages(msgOrint: ExtendedMessage | ExtendedInteraction, pages: EmbedBuilder[], options?: pagesOptions): Promise<void>;
