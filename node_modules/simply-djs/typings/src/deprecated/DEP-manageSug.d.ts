import { manageSuggestOptions } from '../handler/manageSuggest';
 ...
 */
export declare function manageSug(interaction: ButtonInteraction, options?: manageSuggestOptions): Promise<void>;
