...
import { SuggestResolve, suggestOptions } from '../suggest';
/**
 * ## _~suggestSystem~_
 *
 ...
 *
 */
export declare function suggestSystem(msgOrint: ExtendedMessage | ExtendedInteraction, options?: suggestOptions): Promise<SuggestResolve>;
