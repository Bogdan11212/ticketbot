...
import { GiveawayResolve, giveawayOptions } from '../giveaway';
 ...
 *
 */
export declare function giveawaySystem(msgOrint: ExtendedMessage | ExtendedInteraction, options?: giveawayOptions): Promise<GiveawayResolve | EndResolve>;
